...
2. **Classical Assumption Tests:**
    ...
    - **Normality:** Jarque-Bera test for residuals.
3. **Model Selection:** Evaluation of Fixed Effects vs. Random Effects (Hausman Test).
4. **Moderation Analysis:** Assessing the interaction terms (e.g., $NPM \times Fimr Size$).

## 📊 Key Findings
* **Liquidity (CR):** Shows a negative coefficient, aligning with the Pecking Order Theory, though the relationship lacks high empirical strength in this specific sample.
